...
fileQueue.process(async (job, done) => {
  const dataUserID = job.data.userId || null;
  const dataFileID = job.data.fileId || null;
  ...
  const userObjId = new ObjectID(dataUserID);
  const fileObjId = new ObjectID(dataFileID);
